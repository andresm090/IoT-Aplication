...
serverMQTT.connect(function(clientMQTT) {
	...
	//Topicos de la app
	clientMQTT.subscribe('+/+/C'); //En esta trama se espera las variables climaticas del equipo generador, separadas por guion medio (Ej 25-12-217)
	clientMQTT.subscribe('+/+/P'); //En esta trama se espera las variables de potencia del equipo generador, separadas por guion medio (Ej 24-5-550)
	clientMQTT.subscribe('+/+/Ei'); //En esta trama se espera un valor correspondiente al angulo de inclinacion del panel, los cuales pueden ser 4 (60, 40, 20 y 12)
	clientMQTT.subscribe('+/+/Ef'); //En esta trama se espera un 1 o un 0, correspondiente a la activación o no del mecanismo de freno.  
